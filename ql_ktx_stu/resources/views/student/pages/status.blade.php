                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        @if ($register->status === 'approved')
                            <span class="badge bg-success px-3 py-2">✓ Được duyệt</span>
                        @elseif ($register->status === 'pending')
                            <span class="badge bg-warning px-3 py-2">⏳ Chờ duyệt</span>
                        @else
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="p-2 bg-light rounded border text-capitalize">{{ $register->gender }}</div>
                        </div>
                        ...
                        <div class="col-12">
                            <label class="fw-bold text-muted">Khoa</label>
                            <div class="p-2 bg-light rounded border">
                                @php
                                    $student = \App\Models\PersonalProfile::where('student_code', $register->student_code)->first();
                                @endphp
