                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control" value="{{ $profile->class_name }}" disabled>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control" value="{{ $profile->gender }}" disabled>
                        </div>

                        <div class="col-md-12">
                            <label class="form-label fw-bold">Quê Quán</label>
                            <input class="form-control" value="{{ $profile->hometown }}" disabled>
                        </div>
